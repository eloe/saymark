...
| Single-shot final insertion | Focus/selection lease, bounded receipt, and newer-clipboard preservation are implemented; real-target certification remains open. | [#24](https://github.com/eloe/saymark/issues/24) | [`live-insertion-sdd.md`](live-insertion-sdd.md) |
| Provisional field mutation | Pure fail-closed policy remains an inert research boundary; production mutation and its target program are not planned for 1.0. | Decisions [#25](https://github.com/eloe/saymark/issues/25), [#26](https://github.com/eloe/saymark/issues/26), [#27](https://github.com/eloe/saymark/issues/27) | [`v1-scope-decisions.md`](v1-scope-decisions.md) |
...
| Vocabulary | Deterministic local correction, management UI, schema-v2 interchange, and legacy-v1 import migration are shipped; model-native biasing is not planned for 1.0. | Evidence [#30](https://github.com/eloe/saymark/issues/30), [#31](https://github.com/eloe/saymark/issues/31); decision [#32](https://github.com/eloe/saymark/issues/32) | [`language-correction-quality-sdd.md`](language-correction-quality-sdd.md), [`v1-scope-decisions.md`](v1-scope-decisions.md) |
| Recent Dictations | Opt-in text-only history, search, recovery, retention, and deletion are shipped; export, file import, and audio retention are not planned for 1.0. | Scale [#36](https://github.com/eloe/saymark/issues/36); decisions [#33](https://github.com/eloe/saymark/issues/33), [#34](https://github.com/eloe/saymark/issues/34), [#35](https://github.com/eloe/saymark/issues/35) | [`recent-dictations-sdd.md`](recent-dictations-sdd.md), [`v1-scope-decisions.md`](v1-scope-decisions.md) |
| Onboarding and identity | Native onboarding and Saymark branding are shipped foundations; direct acceptance remains, while competitor parity and open-ended inheritance work are not 1.0 gates. | Evidence [#38](https://github.com/eloe/saymark/issues/38); decisions [#37](https://github.com/eloe/saymark/issues/37), [#39](https://github.com/eloe/saymark/issues/39) | [`v1-scope-decisions.md`](v1-scope-decisions.md), [`../Branding/BRAND_DIRECTION.md`](../Branding/BRAND_DIRECTION.md) |
| Formatting modes | Not shipped and not planned for 1.0. | Decision [#40](https://github.com/eloe/saymark/issues/40) | [`v1-scope-decisions.md`](v1-scope-decisions.md) |
| Context workflows | Not shipped and not planned for 1.0. | Decision [#41](https://github.com/eloe/saymark/issues/41) | [`v1-scope-decisions.md`](v1-scope-decisions.md) |
| Languages and translation | English-only 1.0; selection, detection, and translation are not planned. | Decision [#42](https://github.com/eloe/saymark/issues/42) | [`v1-scope-decisions.md`](v1-scope-decisions.md) |
| Meetings | Not shipped and not planned for 1.0. | Decision [#43](https://github.com/eloe/saymark/issues/43) | [`v1-scope-decisions.md`](v1-scope-decisions.md) |
| Sync and portable platforms | Versioned local Vocabulary interchange exists; sync and other platforms are not planned for 1.0. | Decision [#44](https://github.com/eloe/saymark/issues/44) | [`v1-scope-decisions.md`](v1-scope-decisions.md) |
